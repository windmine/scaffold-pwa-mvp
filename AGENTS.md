...
- The 2026-09-16 PDF-only backend release is **deployed and verified**: source `7ad0f88`, build `50649bcc-9d50-455a-9df0-274bc296ab03`, image digest `sha256:08edbc28d3dfca0922941619900c6c7102a7dd4dc825d56422a9437b7bfb82dc`, revision `geo-backend-pdf-20260916-0010`, 100% with no tags. No migration, maintenance pause or Hosting promotion; September 15 frontend/cache and runtime configuration remain unchanged. Department-branded A4 single/collection PDFs include the supplied Mutual logo. [Release proof](docs/evidence/report-pdf-release-20260916/release.json) records local gates, zero-traffic candidate/live authenticated checks, 18 reviewed/pixel-matched pages, actual phone-sized browser export-button downloads, unchanged demo Report/Template/upload/CSV/HTML hashes and 196 clean revision log entries. Keep `geo-backend-report-20260915-0025` as compatible rollback. Physical-phone PDF viewers remain unverified. Live Mutual demo Reports 5–13, Templates 7–9, accounts 13–16, Sites 5–6 and six uploads are intentionally retained under [exact cleanup ownership](docs/evidence/presentation-demo-20260916.json); never broadly delete by DEMO name.
