...
The verified September 18 release serves backend `geo-backend-report50-20260918` at 100% with no tags and Hosting `3e7a08c85e6ca5e5`, cloned from `release-20260918` at `2026-09-18T06:00:16.936Z`. Backend source is `d840fbf`; frontend is `44e04c3`, production cache `leader-field-ed9e6cddf6aa`. No migration or maintenance pause occurred; the ledger remains 21 entries through `0021_worker_invitations`. The [release record](docs/evidence/report-release-20260918/release.json) records the 68-workflow final local gate, preview/live 12-checkpoint 50-photo runs, shell/installer/waiting-update checks, exact fixture cleanup and 18-page PDF pixel parity. The report-only shell now uses compact Worker cards, mobile inbox/detail review and PDF-primary exports. Preserve Blob-compatible frontend and 50-photo-compatible backend rollback semantics. The controlled pilot was explicitly approved while physical-phone, full-resolution-gallery and maximum-size photo batches remain unverified; a hosted automated pass is not phone-capacity approval.
