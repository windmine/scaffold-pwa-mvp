...
The September 25 release serves source `eb249ef1ee8b966a4149b15cfe092e3c0c3d10fc`: backend `geo-backend-onboarding-20260925` at 100% with no tags, followed by exact Hosting `d492562f1d2bdb50` cloned from `release-20260925` at `2026-09-24T23:13:21.309Z`. Production cache is `leader-field-0643513b54a8`; source cache is `leader-field-16d27ec7cb96`. No migration, maintenance pause or runtime configuration change occurred; the ledger remains 21 entries through `0021_worker_invitations`. The [release record](docs/evidence/report-release-20260925/release.json) binds local, candidate, preview/live and exact-owned cleanup evidence. Non-blocking startup/progress, quieter screens and guarded private onboarding are live alongside compact Worker cards, mobile inbox/detail review and PDF-primary exports. The [September 18 record](docs/evidence/report-release-20260918/release.json) remains historical evidence for the underlying Blob/50-photo release.

Preserve Blob-compatible frontend and 50-photo-compatible backend rollback semantics. Exact previous Hosting `3e7a08c85e6ca5e5` is retained in `rollback-20260925` until recorded `2026-10-01T23:03:40.749687450Z` expiry; reverify before use and never clear device storage. Physical-phone, native-sharing handoff, full-resolution-gallery and maximum-size photo batches remain unverified; hosted automation is not phone-capacity approval. No email provider or self-service password reset was added.
