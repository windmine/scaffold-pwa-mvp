...
The earlier base64 storage smoke reached 1.20 GiB sampled desktop memory; the Blob comparison above supersedes that implementation. Physical-phone testing of realistic camera batches and 50 near-5-MB files remains pending. On 2026-09-18 the operator explicitly approved deployment to the controlled live pilot with this limitation; this is not broad phone-capacity approval. Details and test limits are recorded in the [mobile checklist](docs/mobile-browser-workflow-checks.md#local-50-photo-report-candidate-not-deployed).
...
## Previous Backend / Current Frontend Release - Reports, Drafts and Worker Invitations, 2026-09-15

The following records the September 15 cutover; the September 16 PDF-only backend above supersedes its serving backend revision.
