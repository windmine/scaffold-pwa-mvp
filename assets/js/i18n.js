...
const ZH_TEXT = {
  ...
  'Choose a section': '选择栏目',
  'Supervisor sections': '主管栏目',
  'New Report': '新建报告',
  'My Reports': '我的报告',
  ...
  'A resolution note is required.': '必须填写解决备注。',
  'Report review started.': '已开始审核报告。',
  'Report resolved.': '报告已解决。',
  'Export Reports CSV': '导出报告 CSV',
  'Export Reports PDF': '导出报告 PDF',
  'Submit Report': '提交报告',
  'Submit report': '提交报告',
  'Select a report template': '选择报告模板',
  'Staff': '员工',
  'Review submitted reports': '审核已提交报告',
  'Review submitted report answers and evidence, then start review or resolve with a final note.': '审核已提交报告的答案和证据，然后开始审核或填写最终备注并解决报告。',
  'Submitted reports': '已提交报告',
  'Report review': '报告审核',
  'Validate submitted reports': '审核已提交报告',
  'Choose a report, review its answers and evidence, then move it through the report workflow.': '选择一份报告，审核其答案和证据，然后按报告流程处理。',
  'Create and manage templates': '创建和管理模板',
  'Manage report access': '管理报告权限',
  'New report template': '新建报告模板',
  'Build a report template': '创建报告模板',
  'Add report template': '添加报告模板',
  'Template name': '模板名称',
  'PPE issue report': '个人防护装备发放报告',
  'Manage report templates': '管理报告模板',
  'Manage staff access': '管理员工权限',
  ...
  'Build, preview, version, archive, and reactivate the templates workers use for reports.': '创建、预览、版本化、归档并重新启用员工提交报告时使用的模板。',
  'Review report answers and evidence, then approve, reject, or correct each submission.': '审核报告答案和证据，然后批准、拒绝或更正每次提交。',
  'Choose a report, review its answers and evidence, then approve, reject, or correct it.': '选择一份报告，审核其答案和证据，然后批准、拒绝或更正。',
  'Create the questions workers will answer in their reports. Advanced syntax remains available when needed.': '创建员工在报告中需要回答的问题。需要时仍可使用高级语法。',
  'Create worker and supervisor accounts, manage access, and retain report ownership when employment status changes.': '创建员工和主管账户、管理权限，并在在职状态变化时保留报告归属。',
  ...
  'Remove repeating group?': '删除重复分组？',
  'This removes the repeating group and every field inside it from this draft.': '此操作会从此草稿中删除该重复分组及其中的所有字段。',
  'Remove group': '删除分组',
  'Change field type?': '更改字段类型？',
  'This removes current options, formula, or grouped fields from this draft.': '此操作会从此草稿中删除当前选项、公式或分组字段。',
  'Change field type': '更改字段类型',
  ...
  'Exceptions': '异常',
  'Open Review record': '\u6253\u5f00\u5ba1\u6838\u8bb0\u5f55',
  'Show map point': '\u663e\u793a\u5730\u56fe\u70b9',
  'Opened the related Review Record.': '\u5df2\u6253\u5f00\u76f8\u5173\u5ba1\u6838\u8bb0\u5f55\u3002',
  'Opened the related attendance map point.': '\u5df2\u6253\u5f00\u76f8\u5173\u8003\u52e4\u5730\u56fe\u70b9\u3002',
  'Could not open the related Review Record.': '\u65e0\u6cd5\u6253\u5f00\u76f8\u5173\u5ba1\u6838\u8bb0\u5f55\u3002',
  'Could not open the related attendance map point.': '\u65e0\u6cd5\u6253\u5f00\u76f8\u5173\u8003\u52e4\u5730\u56fe\u70b9\u3002',
  'The related Review Record is no longer available. Refresh Analytics and try again.': '\u76f8\u5173\u5ba1\u6838\u8bb0\u5f55\u5df2\u4e0d\u53ef\u7528\u3002\u8bf7\u5237\u65b0\u5206\u6790\u540e\u91cd\u8bd5\u3002',
  'The related Review Record is outside the active department scope.': '\u76f8\u5173\u5ba1\u6838\u8bb0\u5f55\u4e0d\u5728\u5f53\u524d\u90e8\u95e8\u8303\u56f4\u5185\u3002',
  'The related Review Record no longer matches the active scope.': '\u76f8\u5173\u5ba1\u6838\u8bb0\u5f55\u4e0d\u518d\u7b26\u5408\u5f53\u524d\u8303\u56f4\u3002',
  'The related attendance map point is unavailable in the active scope.': '\u5f53\u524d\u8303\u56f4\u5185\u6ca1\u6709\u53ef\u7528\u7684\u76f8\u5173\u8003\u52e4\u5730\u56fe\u70b9\u3002',
  'The related attendance map point no longer matches the active scope.': '\u76f8\u5173\u8003\u52e4\u5730\u56fe\u70b9\u4e0d\u518d\u7b26\u5408\u5f53\u524d\u8303\u56f4\u3002',
  ...
  'Submitted Reports CSV': '已提交报告 CSV',
  ...
  'Creating Report Template...': '正在创建报告模板...',
  'Saving Report Template...': '正在保存报告模板...',
  ...
  'This draft was saved with an earlier Report Template version. Review it before submitting.': '此草稿使用较早的报告模板版本保存。提交前请检查。',
  'Could not prepare these photos. Choose them again before leaving this page.': '无法处理这些照片。离开此页面前请重新选择。',
  'Could not capture this Report draft.': '无法保存此报告草稿。',
  'Wait for the Report submission to finish.': '请等待报告提交完成。',
  'This Report still has unsaved changes.': '此报告仍有未保存的更改。',
  'Please confirm': '请确认',
  'Confirm action': '确认操作',
  'Review the details before continuing.': '请先检查详细信息，然后再继续。',
  'Confirm': '确认',
  'Delete pending attendance?': '删除待处理考勤？',
  'This permanently removes the pending attendance record and its photos. This cannot be undone.': '此操作会永久删除待处理的考勤记录及其照片，且无法撤销。',
  'Delete attendance': '删除考勤',
  'Discard unsynced submission?': '放弃未同步提交？',
  'This permanently removes the device-only submission and its queued photo progress. It cannot be recovered.': '此操作会永久删除仅存于本设备的提交及其排队照片进度，且无法恢复。',
  'Discard submission': '放弃提交',
  'Mark worker resigned?': '将员工标记为离职？',
  'Reactivate worker?': '重新启用员工？',
  'This blocks the Worker from signing in. Their previous records stay attached to the account.': '此操作会阻止员工登录。其历史记录仍会保留在该账号中。',
  'This restores account access for the Worker. Their previous records stay attached to the account.': '此操作会恢复该员工的账号访问权限。其历史记录仍会保留在该账号中。',
  'Reactivate worker': '重新启用员工',
  'Save account changes?': '保存账号更改？',
  'Email, password, role, Department, status, or Global Admin changes can affect sign-in and data access immediately.': '邮箱、密码、角色、部门、状态或全局管理员更改可能会立即影响登录和数据访问。',
  'Save account changes': '保存账号更改',
  'Save Site changes?': '保存工地更改？',
  'Coordinates and radius changes affect future inside/outside attendance results for this Site.': '坐标和半径更改会影响此工地今后的考勤范围内或范围外结果。',
  'Save Site changes': '保存工地更改',
  'Move record to the rubbish bin?': '将记录移到回收站？',
  'This hides the record from active review for up to 30 days. It can be restored before permanent deletion.': '此操作会将记录从当前审核中隐藏最多 30 天。在永久删除前可恢复。',
  'Move record': '移动记录',
  'Add approved attendance?': '添加已批准考勤？',
  'This creates approved attendance without Worker GPS evidence. The action is audit-logged.': '此操作会创建没有员工 GPS 证据的已批准考勤，并记录到审计日志中。',
  'Add approved attendance': '添加已批准考勤',
  'Submit an approved record?': '提交已批准记录？',
  'This creates an approved record for the selected user and skips pending review. The action is audit-logged.': '此操作会为所选用户创建已批准记录并跳过待审核状态，同时记录到审计日志中。',
  'Submit approved record': '提交已批准记录',
  'Save official record changes?': '保存正式记录更改？',
  'This changes a durable Review Record. The update is audit-logged and can affect reporting.': '此操作会更改持久化审核记录，并记录到审计日志中，且可能影响报告。',
  'Save official record': '保存正式记录',
  'Review desk': '\u5ba1\u6838\u5de5\u4f5c\u53f0',
  ...
  'Select members': '选择成员',
  'Select a Report Template': '选择报告模板',
  'Template, answer, status': '模板、答案、状态',
  'Worker, template, answer': '员工、模板、答案',
  'Photos': '照片',
  'My history': '我的历史',
  'Refresh': '刷新',
  'Find': '查找',
  ...
  'In review': '审核中',
  'Resolved': '已解决',
  'Final supervisor note:': '主管最终备注：',
  'Reviewing supervisor:': '审核主管：',
  'Review started:': '开始审核：',
  'Resolved:': '已解决：',
  'No supervisor note was recorded.': '未记录主管备注。',
  'Pending': '待审核',
  'Approved': '已通过',
  'Rejected': '已拒绝',
  'Queued': '已排队',
  ...
  'From': '\u5f00\u59cb',
  'To': '\u7ed3\u675f',
  'All Report Templates': '所有报告模板',
  'Report Template not used': '不适用报告模板',
  'Daily task log sheets': '每日任务记录表',
  'Task photo report': '任务照片报告',
  'Daywork PDF': '日工 PDF',
  'Submitted Reports PDF': '已提交报告 PDF',
  'Submitted Reports HTML': '已提交报告 HTML',
  ...
  'Add staff': '添加员工',
  'New account': '新账号',
  'Add staff user': '添加员工用户',
  'Role': '角色',
  'Department': '部门',
  'No department': '无部门',
  'Global admin': '全局管理员',
  'Global admin (Supervisor only)': '全局管理员（仅限主管）',
  'Global admin access requires the Supervisor role': '全局管理员权限仅适用于主管角色',
  'Only global admins can grant global admin access': '只有全局管理员可以授予全局管理员权限',
  'global admin': '全局管理员',
  'Worker': '员工',
  'Supervisor': '主管',
  'Create user': '创建用户',
  ...
  'A new app version is ready. Your Report will be saved before the app reloads.': '新版本已准备好。应用重新加载前会先保存您的报告。',
  'Protecting your work': '保护您的工作',
  'Update paused': '更新已暂停',
  'This Report has changes that are not saved on this device. Updating now could lose them.': '此报告有尚未保存在本设备上的更改。现在更新可能会丢失这些内容。',
  'Wait for the Report submission to finish before updating.': '请等待报告提交完成后再更新。',
  'Try saving again': '重试保存',
  'Keep editing': '继续编辑',
  'Saving before update...': '更新前正在保存...',
  'Draft saved. Updating app...': '草稿已保存。正在更新应用...',
  'The app update is no longer waiting. Your Report draft is saved.': '应用更新已不再等待。您的报告草稿已保存。',
  'Could not start the app update. Your Report draft is saved; try Update App again.': '无法启动应用更新。您的报告草稿已保存；请再次尝试“更新应用”。',
  'Updating app...': '正在更新应用...',
  ...
  'Your Report is not saved yet. Keep editing and try again before logging out.': '您的报告尚未保存。请继续编辑，并在退出登录前重试。',
  'Your session expired, but this Report is not saved on this device. Keep this page open and try saving again.': '您的会话已过期，但此报告尚未保存在本设备上。请保持此页面打开并重试保存。',
  ...
  'Choose a Report Template first.': '请先选择报告模板。',
  'Could not submit Report.': '无法提交报告。',
  'Could not load Report Templates.': '无法加载报告模板。',
  'Report photo': '报告照片',
  ...
  'Review the fields before saving. This changes backend records.': '保存前请检查各字段。此操作会更改后端记录。',
  ...
  'Reports exported.': '报告已导出。',
  'Reports CSV exported.': '报告 CSV 已导出。',
  'Reports PDF exported.': '报告 PDF 已导出。',
  ...
  'Report PDF exported.': '报告 PDF 已导出。',
  'This submission is not a Daywork form.': '此提交不是日工表单。',
  'Report CSV row exported.': '报告 CSV 行已导出。',
  ...
  'Mark resigned': '标记离职',
  'Reactivate': '重新启用',
  'Add at least one Report field.': '请至少添加一个报告字段。',
  'Report Template created.': '报告模板已创建。',
  'Report Template created, but the updated list could not load.': '报告模板已创建，但无法加载更新后的列表。',
  'Could not create Report Template.': '无法创建报告模板。',
  'Untitled Report Template': '未命名报告模板',
  'Add fields to preview this Report Template.': '添加字段后可预览此报告模板。',
  'Worker preview': '员工预览',
  'Worker selects site': '员工选择工地',
  'Hide preview': '隐藏预览',
  'Preview': '预览',
  'Save Report Template': '保存报告模板',
  'Report Template updated.': '报告模板已更新。',
  'Could not update Report Template.': '无法更新报告模板。',
  'No Report Templates found yet.': '尚未找到报告模板。',
  'No description': '无说明',
  'Section:': '小节：',
  'time range': '时间范围',
  'formula': '公式',
  ...
  'Archive': '归档',
  'Activate': '启用',
  'Report Template activated.': '报告模板已启用。',
  'Report Template archived.': '报告模板已归档。',
  'Site created and added to worker Report options.': '工地已创建并添加到员工报告选项。',
  'Save Report': '保存报告',
  'Report updated.': '报告已更新。',
  'Could not update Report.': '无法更新报告。',
  'Report Template name is required': '报告模板名称为必填项',
  'A Report Template with this name already exists': '已存在同名报告模板',
  'Report Template not found': '未找到报告模板',
  'Report not found': '未找到报告',
  "Report Template must belong to the selected user's department": '报告模板必须属于所选员工的部门',
  'Could not update the Report workflow.': '无法更新报告流程。',
  'Reconnect before exporting Reports.': '请重新联网后再导出报告。',
  'Could not export Reports.': '无法导出报告。',
  'status must be in_review or resolved': '状态必须为审核中或已解决',
  'A Supervisor note is required to resolve a Report': '解决报告时必须填写主管备注',
  'Report was transitioned by another Supervisor; refresh Reports': '另一位主管已更改此报告的流程状态；请刷新报告。',
  'Submitted Report content is immutable; Site, Report Date, answers, photos, and signatures cannot be edited': '已提交报告的内容不可更改；不能编辑工地、报告日期、答案、照片和签名',
  'Report document export failed.': '报告文档导出失败。',
  'Report CSV export failed.': '报告 CSV 导出失败。',
  'Report PDF export failed.': '报告 PDF 导出失败。',
  'Report Template builder root is required.': '报告模板生成器根节点为必填项。',
  ...
  'Staff user created, but the updated list could not load.': '员工用户已创建，但无法加载更新后的列表。',
...
const ZH_PATTERNS = [
  ...
  [/^Reports can include up to (\d+) photos\. The first (\d+) were kept\.$/, (match) => `每份报告最多可包含 ${match[1]} 张照片。已保留前 ${match[2]} 张。`],
  [/^Submitted: (.+)$/, (match) => `提交时间：${match[1]}`],
  [/^Report Date: (.+)$/, (match) => `报告日期：${match[1]}`],
  [/^Report status: (.+)$/, (match) => `报告状态：${translateText(match[1], 'zh')}`],
  [/^Resolve report: (.+)$/, (match) => `解决报告：${match[1]}`],
  [/^Report must be (submitted|in_review) before it can become (in_review|resolved); refresh Reports$/, (match) => {
    const labels = { submitted: '已提交', in_review: '审核中', resolved: '已解决' };
    return `报告必须处于“${labels[match[1]]}”状态才能变为“${labels[match[2]]}”；请刷新报告。`;
  }],
  [/^Edit Report Template: (.+)$/, (match) => `编辑报告模板：${match[1]}`],
  [/^Edit Report: (.+)$/, (match) => `编辑报告：${match[1]}`],
  ...
  [/^(.+) \(calculated\)$/, (match) => `${translateText(match[1], 'zh')}（自动计算）`],
  ...
  [/^(\d+) queued records? still need attention\. Open (My Reports|My history) to retry or discard them\.$/, (match) => (
    `${match[1]} 条排队记录仍需处理。请打开“${translateText(match[2], 'zh')}”重试或丢弃。`
  )],
  [/^Sync still failed\. Check the error in (My Reports|My history), then discard and resubmit if the photo needs replacing\.$/, (match) => (
    `同步仍失败。请在“${translateText(match[1], 'zh')}”中查看错误；如需更换照片，请丢弃后重新提交。`
  )],
  ...
  [/^(.+) submitted for review\.$/, (match) => `${match[1]} 已提交审核。`],
