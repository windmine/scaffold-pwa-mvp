...
const ZH_TEXT = {
  ...
  'Share privately': '私下分享',
  'Sharing cancelled.': '已取消分享。',
  'ReportFlow invitation': 'ReportFlow 邀请',
  'Private setup link for {identity}. Open it to choose your password.': '{identity} 的私密设置链接。请打开链接设置您的密码。',
  'Sharing finished. Confirm the intended Worker received the link.': '分享操作已完成。请确认对应员工已收到链接。',
  'Sharing is unavailable. Copy the link and send it privately.': '无法分享。请复制链接并私下发送。',
  'Set password and continue': '设置密码并继续',
  'Choose a private password for your Worker account.': '请为您的员工账户设置私密密码。',
  'Your supervisor will not see your password.': '主管不会看到您的密码。',
  'Link not working?': '链接无法使用？',
  'This browser may already have an account or saved work. Password setup will not switch accounts.': '此浏览器可能已有账户或已保存的工作。设置密码不会切换账户。',
  'Password set. Signing you in...': '密码已设置。正在登录……',
  'An existing browser session was left unchanged. Open the app and sign out there before using this account.': '现有浏览器会话保持不变。请打开应用并退出登录后，再使用此账户。',
  'Your password is saved, but sign-in could not finish. Use Sign in to ReportFlow below.': '密码已保存，但登录未能完成。请使用下方“登录 ReportFlow”链接。',
  'Another page changed the active account. Open the app to check your session before continuing.': '其他页面更改了当前账户。请打开应用，检查登录状态后再继续。',
  'Open the app to continue with its current account, or sign out there before using your new account.': '请打开应用继续使用当前账户，或先退出登录再使用新账户。',
  'Need help signing in?': '需要登录帮助？',
  'Install on your phone': '安装到手机',
  ...
  'You can keep working. Keep this page open until syncing finishes.': '您可以继续填写报告。同步完成前请保持此页面打开。',
  'Uploads saved. Finishing submission...': '上传文件已保存，正在完成提交……',
  'Finishing saved submission...': '正在完成已保存的提交……',
  'Saved submissions synced.': '已保存的提交已同步。',
  'Saved submissions will retry when you reconnect. You can keep working offline.': '重新联网后将重试已保存的提交。您可以继续离线填写。',
  'Some saved submissions need attention. Open My Reports to check and retry.': '部分已保存的提交需要处理。请打开“我的报告”检查并重试。',
  'Saved submissions are waiting to sync': '已保存的提交正在等待同步',
  'Another upload may still be active. Check My Reports before retrying.': '另一次上传可能仍在进行。重试前请检查“我的报告”。',
  'Sync paused - check saved submissions': '同步已暂停，请检查已保存的提交',
  'Sync paused. Open My Reports to check saved submissions and retry.': '同步已暂停。请打开“我的报告”检查已保存的提交并重试。',
  'Could not refresh saved submissions. Open My Reports to check their status.': '无法刷新已保存的提交。请打开“我的报告”查看状态。',
  'This submission is still syncing. Wait for it to finish before discarding it.': '此提交仍在同步。请等待同步完成后再丢弃。',
  'Download PDF': '下载 PDF',
  ...
  'Saved copy. Open details to recover your answers and evidence.': '已保存副本。打开详情以恢复答案和证据。',
  'Saved on this device. Waiting to sync.': '已保存在本设备上，等待同步。',
  'Uploading your report.': '正在上传您的报告。',
  'Sync needs attention.': '同步需要处理。',
  'Could not remove this photo. Your photos have not changed. Try again.': '无法移除此照片。您的照片未更改，请重试。',
  'Report Date: Not set': '报告日期：未设置',
  'Unfinished Templates on this device': '本设备上的未完成模板',
  'Private editing drafts. Workers cannot see them until you save the Template.': '这些编辑草稿仅保存在本设备上。保存模板后，员工才能看到更改。',
  'Edit Report Template': '编辑报告模板',
  'Saved on this device': '已保存在本设备上',
  'Saving Template draft...': '正在保存模板草稿...',
  'Template draft saved on this device.': '模板草稿已保存在本设备上。',
  'Template draft could not be saved. Keep this page open and try again.': '无法保存模板草稿。请保持此页面打开，然后重试。',
  'Continue Template draft': '继续编辑模板草稿',
  'Could not restore Template draft.': '无法恢复模板草稿。',
  'Discard Template draft': '丢弃模板草稿',
  'Discard Template draft?': '丢弃模板草稿？',
  'This removes only the unfinished editing copy on this device. Published Templates and Reports are unchanged.': '这只会删除本设备上未完成的编辑副本。已发布的模板和已提交的报告不会受到影响。',
  'Discard draft': '丢弃草稿',
  'Could not discard Template draft.': '无法丢弃模板草稿。',
  'Template drafts are unavailable on this device.': '无法读取本设备上的模板草稿。',
  'Close and keep draft': '关闭并保留草稿',
  'Wait for the Template operation to finish before leaving or updating.': '请等待模板操作完成后，再离开此页面或更新应用。',
  'Your Template changes are not saved on this device. Keep this page open and try again before leaving or updating.': '模板更改尚未保存在本设备上。请保持此页面打开并重试，保存成功后再离开或更新应用。',
  'This draft was removed or saved in another editor. Your recovery copy is read-only; check the Template list before editing again.': '此草稿已在另一个编辑页面中被删除或保存。恢复副本仅供查看；请先检查模板列表，再重新编辑。',
  'Template saved, but its local draft could not be cleared. The recovery copy is read-only.': '模板已保存，但无法清除本地草稿。恢复副本仅供查看。',
  'The previous save may have reached the server. This draft is kept read-only; check the Template list before creating or editing again.': '上次保存可能已送达服务器。此草稿保留为只读；请先检查模板列表，再重新创建或编辑。',
  'Could not create Report Template. Your editing draft is kept.': '无法创建报告模板。编辑草稿已保留。',
  'Connect to load the current Report Template before editing.': '请先联网加载当前报告模板，再进行编辑。',
  'Connect before publishing the Template. Your private editing draft stays on this device.': '请联网后再发布模板。私有编辑草稿会保留在此设备上。',
  'The Template changed or is unavailable. Your editing draft is kept read-only. Open the current Template separately; your draft will not overwrite it.': '模板已更改或暂不可用。编辑草稿保留为只读。请另行打开当前模板；此草稿不会覆盖当前模板。',
  'Changes stay private on this device until you save the Report Template.': '保存报告模板之前，更改仅保存在本设备上，员工不可见。',
  'Could not open Template draft.': '无法打开模板草稿。',
  'Report Template updated, but the updated list could not load.': '报告模板已更新，但无法加载最新列表。',
  'This draft was not applied safely. It is kept read-only; check the current Template before editing again.': '未能确认此草稿已安全保存。现保留为只读；请先检查当前模板，再重新编辑。',
  'Could not save Report Template. Your editing draft is kept.': '无法保存报告模板。编辑草稿已保留。',
  'This Template draft changed or was removed in another editor. Keep your input and reopen the saved draft.': '此模板草稿已在另一个编辑页面中更改或删除。请保留当前输入，并重新打开已保存的草稿。',
  'Template draft storage failed.': '无法存储模板草稿。',
  'Template draft storage aborted.': '模板草稿存储已中止。',
  'Template draft does not belong to this account.': '模板草稿不属于此账户。',
  'Template draft storage returned an invalid result.': '模板草稿存储返回了无效结果。',
  'This editor has changes that are not saved on this device. Updating now could lose them.': '此编辑页面中的更改尚未保存在本设备上。现在更新可能会丢失这些更改。',
  'A new app version is ready. Your drafts will be saved before the app reloads.': '新版本已准备好。应用重新加载前会先保存您的草稿。',
  'The app update is no longer waiting. Your draft is saved.': '当前已没有等待安装的应用更新。草稿已保存。',
  'Could not start the app update. Your draft is saved; try Update App again.': '无法启动应用更新。草稿已保存；请再次尝试“更新应用”。',
  'Workers set their own password using a private, expiring setup link. No email is sent automatically.': '员工通过私密且有有效期的设置链接自行设置密码。系统不会自动发送邮件。',
  'Create invitation': '创建邀请',
  'Worker invitation ready': '员工邀请已准备好',
  "Share this link privately with the intended Worker. Anyone with it can set this account's password. No email has been sent.": '请将此链接私下发送给对应员工。持有链接的人可以设置此账户的密码。系统未发送邮件。',
  'Expires': '有效期至',
  'Private setup link': '私密设置链接',
  'The link is shown only now. Closing this window hides it; create a new link from Staff if needed.': '此链接仅在本次显示。关闭窗口后将隐藏；如有需要，请在员工页面创建新链接。',
  'Done': '完成',
  'Copy private link': '复制私密链接',
  'Link copied. Share it privately with this Worker.': '链接已复制。请私下发送给对应员工。',
  'Copy is unavailable. Select and copy the link above.': '无法自动复制。请选中并复制上方链接。',
  'The account was created, but its invitation link is unavailable. Refresh Staff and create a new link.': '账户已创建，但邀请链接不可用。请刷新员工页面并创建新链接。',
  'Password setup required': '待设置密码',
  'Awaiting password setup': '等待员工设置密码',
  'Invitation expired': '邀请已过期',
  'Invitation revoked': '邀请已撤销',
  'No active invitation': '无有效邀请',
  'Create new setup link': '创建新设置链接',
  'Revoke setup link': '撤销设置链接',
  'Replace setup link?': '替换设置链接？',
  'Revoke setup link?': '撤销设置链接？',
  'The previous link will stop working. Share the new link privately with this Worker.': '旧链接将失效。请将新链接私下发送给对应员工。',
  'This Worker cannot finish password setup with the old link. You can create a new link later.': '此员工将无法通过旧链接设置密码。您可以稍后创建新链接。',
  'Setup link revoked.': '设置链接已撤销。',
  'Could not update the invitation. Refresh Staff and try again.': '无法更新邀请。请刷新员工页面后重试。',
  'Worker invitation created. Share the setup link privately.': '员工邀请已创建。请私下发送设置链接。',
  'New setup link created; the previous link is invalid. The Staff list could not refresh, but you can still copy the new link.': '新设置链接已创建，旧链接已失效。员工列表未能刷新，但您仍可复制新链接。',
  'Setup link revoked, but the Staff list could not refresh. Refresh Staff before making another change.': '设置链接已撤销，但员工列表未能刷新。请刷新员工页面后再进行更改。',
  'Newly invited? Open your private setup link first to choose your password, then return here to sign in.': '首次接受邀请？请先打开私密设置链接设置密码，再返回此处登录。',
  'Set your password': '设置您的密码',
  'This private invitation lets you activate your Worker account. Your supervisor will not see your password.': '通过此私密邀请可启用您的员工账户。主管不会看到您的密码。',
  'Checking invitation...': '正在检查邀请...',
  'New password': '新密码',
  'Confirm password': '确认密码',
  'Use at least 8 characters, up to 72 UTF-8 bytes.': '请使用至少 8 个字符，最多 72 个 UTF-8 字节。',
  'Set password': '设置密码',
  'Try again': '重试',
  'Sign in to ReportFlow': '登录 ReportFlow',
  'If your link expired or was already used, ask your supervisor for a new setup link. If you already set a password, sign in normally.': '如果链接已过期或已使用，请向主管索取新设置链接。如果您已设置密码，请正常登录。',
  'JavaScript and an internet connection are required to set your password.': '设置密码需要启用 JavaScript 并连接网络。',
  'Setting password...': '正在设置密码...',
  'Cannot connect. Check your connection and try again.': '无法连接。请检查网络后重试。',
  'Could not complete password setup. Try again.': '无法完成密码设置。请重试。',
  'Open the complete private setup link from your supervisor.': '请打开主管提供的完整私密设置链接。',
  'Choose a password that only you know.': '请设置仅您本人知道的密码。',
  'Passwords do not match.': '两次输入的密码不一致。',
  'Password must be at most 72 UTF-8 bytes.': '密码最多为 72 个 UTF-8 字节。',
  'Password set. You can now sign in to ReportFlow.': '密码已设置。现在可以登录 ReportFlow。',
  'This invitation is invalid or expired. Ask your Supervisor for a new invitation.': '此邀请无效或已过期。请向主管索取新邀请。',
  'This invitation is invalid or expired. If you just set a password, try signing in; otherwise ask your supervisor for a new link.': '此邀请无效或已过期。如果您刚设置了密码，请尝试登录；否则请向主管索取新链接。',
  'Complete your Worker invitation to set a password before signing in': '请先完成员工邀请并设置密码，然后登录',
  'This Worker must set their own password using an invitation': '此员工必须通过邀请自行设置密码',
  'This Worker must complete password setup before changing role': '此员工必须先完成密码设置才能更改角色',
  'Invitations are only available for active Workers awaiting password setup': '仅可为在职且等待设置密码的员工创建邀请',
  'Worker changed. Refresh Staff and try again.': '员工信息已更改。请刷新员工页面后重试。',
  'Exports include all Reports matching these filters and Find, across every page—not only the loaded records.': '导出包含符合筛选条件及查找内容的所有报告，包括全部分页，而不仅是已加载的记录。',
  ...
  'Drafts on this device': '本设备上的草稿',
  'Not submitted. Only saved on this device.': '尚未提交。仅保存在本设备上。',
  'Continue draft': '继续填写草稿',
  'Opening draft...': '正在打开草稿...',
  'Last saved': '上次保存',
  'Report Templates saved on this device for offline use.': '报告模板已保存在本设备上，可供离线使用。',
  'Report Templates are online only. Device storage is unavailable.': '报告模板目前仅可在线使用。本设备的存储不可用。',
  'No active Report Templates. Ask your supervisor to create or reactivate one.': '没有可用的报告模板。请联系主管创建或重新启用模板。',
  'Using saved Report Templates. You can start or continue a Report offline. Templates are checked again when you reconnect.': '正在使用已保存的报告模板。您可以离线新建或继续填写报告。重新联网后，系统会再次检查模板。',
  'Using this open page\'s Report Templates. They are not saved for offline return visits. Keep this page open.': '正在使用当前页面中已加载的报告模板。模板尚未保存，无法在关闭后离线重新打开。请保持此页面打开。',
  'No Report Templates are saved for offline use. Connect to load your Department\'s active Templates.': '本设备尚未保存可离线使用的报告模板。请联网加载所属部门的可用模板。',
  'Report Templates were not refreshed because this Report has unsaved changes. Keep this page open and try again.': '此报告的更改尚未保存，因此没有刷新模板。请保持此页面打开，然后重试。',
  'Report Template changed. Review the saved draft before starting a new Report.': '报告模板已更改。开始新报告前，请查看已保存的草稿。',
  'Report Template unavailable. Connect and refresh, or ask your supervisor.': '报告模板不可用。请联网刷新，或联系主管。',
  'Could not load saved drafts. Keep New Report open if changes are not saved, then try Refresh.': '无法加载已保存的草稿。如果更改尚未保存，请保持新报告页面打开，然后重试刷新。',
  'This draft cannot be opened with the available Report Templates. Your saved work is unchanged.': '无法使用当前可用的报告模板打开此草稿。已保存的内容保持不变。',
  'Could not open this draft. Keep New Report open if changes are not saved, then try again.': '无法打开此草稿。如果更改尚未保存，请保持新报告页面打开，然后重试。',
  ...
  'Report photo': '报告照片',
  'Choose more photos to add them. Use Remove to discard an individual photo.': '再次选择可添加更多照片。使用“移除”可删除单张照片。',
...
const ZH_PATTERNS = [
  ...
  [/^Upload limit reached\. Retrying in (\d+) seconds\. (\d+) of (\d+) photos and signatures uploaded\.$/, (match) => `已达到上传频率限制，${match[1]} 秒后重试。已上传 ${match[2]} / ${match[3]} 张照片和签名。`],
  ...
  [/^Remove photo (\d+)$/, (match) => `移除照片 ${match[1]}`],
